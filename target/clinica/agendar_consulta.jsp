...
<body>
    ...
    <div class="navbar">
        <div class="nav-links">
            ...
            <a href="${pageContext.request.contextPath}/paciente/minha-agenda">Minha Agenda</a>
...
<div class="content">
    ...
    <form method="post" action="${pageContext.request.contextPath}/agendarConsulta" class="form-container">
